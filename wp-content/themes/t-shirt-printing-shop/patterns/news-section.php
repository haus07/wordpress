 ...
 * News Section
 * 
 * slug: t-shirt-printing-shop/news-section
 * title: News Section
 * categories: t-shirt-printing-shop
 */

    return array(
        'title'      =>__( 'News Section', 't-shirt-printing-shop' ),
...
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"600"},"elements":{"link":{"color":{"text":"var:preset|color|accent"}}}},"textColor":"accent","fontSize":"medium","fontFamily":"poppins"} -->
<p class="has-text-align-center has-accent-color has-text-color has-link-color has-poppins-font-family has-medium-font-size" style="font-style:normal;font-weight:600">'. esc_html__('News & Blogs','t-shirt-printing-shop').'</p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-poppins-font-family" style="font-size:26px;font-style:normal;font-weight:800">'. esc_html__('Our Latest News & blogs','t-shirt-printing-shop').'</h2>
<!-- /wp:heading -->
