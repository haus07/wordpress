<?php
// functions.php (chỉ phần cần thiết — chèn vào đầu file functions.php của theme)
...
function handle_contact_form()
{
    ...
    // Mail gửi đi (From = SMTP account của bạn)
    $from_email = 'thanhdo062305@gmail.com';
    $to = $email; // gửi tới email khách
...
// Newsletter handlers (cũng để ở cấp toàn cục)
