...
<div class="banner">
    <div class="banner-container">
        ...
        <div class="banner-image">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/banners/banner3.png'); ?>" alt="Banner">
        </div>
    </div>
</div>
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="product-card">
                    <a href="<?php the_permalink(); ?>">
                        ...
                        <?php else : ?>
                            <img src="<?php echo esc_url(wc_placeholder_img_src()); ?>" class="product-image" alt="<?php the_title_attribute(); ?>">
                        <?php endif; ?>
                    </a>
